	...
	<body>
		...
		<div id="show-contact" class="content scaffold-show" role="main">
			...
			<ol class="property-list contact">
				...
				<g:if test="${contactInstance?.priority}">
				<li class="fieldcontain">
					<span id="priority-label" class="property-label"><g:message code="contact.priority.label" default="Priority" /></span>
					
						<span class="property-value" aria-labelledby="priority-label"><g:fieldValue bean="${contactInstance}" field="priority"/></span>
